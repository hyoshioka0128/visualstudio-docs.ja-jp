...
![.NET 4.x 同等を選択する](media/vs/vstu-scripting-runtime-version.png)
...
![MonoBleedingEdge ディレクトリ](media/vs/vstu-monobleedingedge.png)
...
1. **[ダウンロード]** ボタンをクリックします。
    ...
    ![ダウンロード ボタン](media/vs/vstu-nuget-download.png)
