...
description: Visual Studio Tools for Unity と Azure でプログラミングします。 Azure には、製品利用統計情報やその他のゲーム データをクラウドに保存する、拡張可能なソリューションが用意されています。
ms.custom: ''
ms.date: 12/18/2017
ms.reviewer: crdun
...
![サンプル ゲームのスクリーンショット](media/vs/vstu-azure-test-sample-game-image2.png)
