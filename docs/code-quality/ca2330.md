---
title: 'CA2330: JsonSerializer が逆シリアル化時にセキュリティで保護された構成を持つことを確認する'
...
ms.locfileid: "73441250"
---
# <a name="ca2330-ensure-that-jsonserializer-has-a-secure-configuration-when-deserializing"></a>CA2330: JsonSerializer が逆シリアル化時にセキュリティで保護された構成を持つことを確認する
...
- [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm)プロパティが `None`以外の値の場合は、常に[Newtonsoft. jsonserializer](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_SerializationBinder.htm)プロパティが設定されていることがわかります。
