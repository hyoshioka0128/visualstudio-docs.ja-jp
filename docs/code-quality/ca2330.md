...
この規則は、 [Newtonsoft.Json.JsonSerializer](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) インスタンスで次の両方の条件が当てはまる場合に発生します。
