...
description: SecurityCritical 属性でマークされたメソッドは、透過的または SecuritySafeCritical 属性でマークされたメソッドをオーバーライドします。または、透過的または SecuritySafeCritical 属性でマークされているメソッドは、SecurityCritical 属性でマークされたメソッドをオーバーライドします。
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2134
