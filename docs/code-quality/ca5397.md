---
title: 'CA5397: 非推奨の SslProtocols の値を使用しないでください'
...
ms.locfileid: "75718611"
---
# <a name="ca5397-do-not-use-deprecated-sslprotocols-values"></a>CA5397: 非推奨の SslProtocols の値を使用しないでください
...
- 非推奨の値を表す整数値は、<xref:System.Security.Authentication.SslProtocols> 変数に割り当てられたか、<xref:System.Security.Authentication.SslProtocols> 戻り値として使用されるか、または <xref:System.Security.Authentication.SslProtocols> 引数として使用されました。
...
[CA5398: SslProtocols の値をハードコーディングしないでください](ca5398.md)
