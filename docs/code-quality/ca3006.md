---
title: 'CA3006: プロセスコマンドインジェクションの脆弱性のコードを確認する'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809904"
---
# <a name="ca3006-review-code-for-process-command-injection-vulnerabilities"></a>CA3006: プロセスコマンドインジェクションの脆弱性のコードを確認する
