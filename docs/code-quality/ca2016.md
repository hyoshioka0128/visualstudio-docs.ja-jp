...
> [!NOTE]
> Rule CA2016 は、 `CancellationToken` 型が使用可能なすべての .net バージョンで使用できます。 「[適用対象」セクションを](https://docs.microsoft.com/dotnet/api/system.threading.cancellationtoken#moniker-applies-to)参照してください CancellationToken
