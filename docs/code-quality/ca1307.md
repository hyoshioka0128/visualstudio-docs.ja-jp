---
title: 'CA1307: 明確にするための StringComparison の指定'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1307
...
---
# <a name="ca1307-specify-stringcomparison-for-clarity"></a>CA1307: 明確にするための StringComparison の指定
...
- [CA1310: 正確な StringComparison を指定します](ca1310.md)
