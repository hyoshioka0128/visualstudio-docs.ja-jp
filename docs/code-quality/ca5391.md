---
title: 'CA5391: ASP.NET Core MVC コントローラーで偽造防止トークンを使用する'
...
ms.locfileid: "85289678"
---
# <a name="ca5391-use-antiforgery-tokens-in-aspnet-core-mvc-controllers"></a>CA5391: ASP.NET Core MVC コントローラーで偽造防止トークンを使用する
