---
title: 'CA5383: ASP.NET Core でセキュリティで保護された cookie を使用する'
...
ms.locfileid: "84185095"
---
# <a name="ca5383-ensure-use-secure-cookies-in-aspnet-core"></a>CA5383: ASP.NET Core でセキュリティで保護された cookie を使用する
