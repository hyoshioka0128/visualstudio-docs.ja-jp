---
title: 'CA0054: カスタム規則アセンブリに無効な XML リソースが含まれています。'
description: これは、カスタム規則アセンブリに規則を記述する無効な XML リソースがある場合に発生します。
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
...
ms.locfileid: "102468365"
---
# <a name="ca0054"></a>CA0054
カスタム規則アセンブリに無効な XML リソースが含まれています。
