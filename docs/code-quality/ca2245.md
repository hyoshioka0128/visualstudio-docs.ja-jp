...
> [!NOTE]
> ルール CA2245 は、レガシ分析では使用できません。 これは、 [FxCop アナライザー](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers)バージョン2.9.8 で初めて導入されました。
...
- [CA2011: setter 内でプロパティを割り当てません](ca2011.md)
