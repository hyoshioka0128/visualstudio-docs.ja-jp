---
title: 'CA5381: 証明書がルートストアに追加されていないことを確認します。'
...
ms.locfileid: "74809825"
---
# <a name="ca5381-ensure-certificates-are-not-added-to-root-store"></a>CA5381: 証明書がルートストアに追加されていないことを確認します。
