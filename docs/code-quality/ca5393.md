---
title: 'CA5393: unsafe DllImportSearchPath 値を使用しないでください'
...
ms.locfileid: "85289674"
---
# <a name="ca5393-do-not-use-unsafe-dllimportsearchpath-value"></a>CA5393: unsafe DllImportSearchPath 値を使用しないでください
...
[CA5392: P/Invoke の DefaultDllImportSearchPaths 属性を使用します。](ca5392.md)
