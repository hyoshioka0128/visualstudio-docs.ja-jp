...
ms.date: 01/29/2018
description: レガシコード分析を使用して .NET マネージコードアセンブリを分析する方法について説明します。 「不具合を確認する方法」および「.NET デザインガイドラインに準拠する方法」を参照してください。
...
1. 残りの各警告について、次の操作を行います。
    ...
    1. 右クリックメニュー (コンテキストメニュー) で、[   >  **抑制ファイルで** 非表示にする] を選択します。
