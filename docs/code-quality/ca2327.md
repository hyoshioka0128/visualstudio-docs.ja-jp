---
title: 'CA2327: セキュリティで保護されていない JsonSerializerSettings を使用しない'
...
ms.locfileid: "74809434"
---
# <a name="ca2327-do-not-use-insecure-jsonserializersettings"></a>CA2327: セキュリティで保護されていない JsonSerializerSettings を使用しない
...
- [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm)プロパティは、`None`以外の値です。
...
[CA2329: セキュリティで保護されていない構成を使用して JsonSerializer で逆シリアル化しないでください](ca2329.md)
