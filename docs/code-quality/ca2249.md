---
title: "CA2249: ' String. IndexOf ' ではなく ' String. Contains ' を使用することを検討してください"
ms.date: 08/27/2020
ms.topic: reference
f1_keywords:
- CA2249
...
ms.locfileid: "89176904"
---
# <a name="ca2249-consider-using-stringcontains-instead-of-stringindexof"></a>CA2249: string. IndexOf の代わりに Contains を使用することを検討してください。
...
*: `StringComparison` 次の以外の列挙値 `StringComparison.Ordinal` 。
