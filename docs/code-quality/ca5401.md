---
title: 'CA5401: 既定以外の IV で CreateEncryptor 機能を使用しません'
...
ms.locfileid: "84184861"
---
# <a name="ca5401-do-not-use-createencryptor-with-non-default-iv"></a>CA5401: 既定以外の IV で CreateEncryptor 機能を使用しません
