---
title: 'CA1310: 正確な StringComparison を指定します'
ms.date: 08/26/2020
ms.topic: reference
f1_keywords:
- CA1310
...
---
# <a name="ca1310-specify-stringcomparison-for-correctness"></a>CA1310: 正確な StringComparison を指定します
...
- [CA1307: 明確にするための StringComparison の指定](ca1307.md)
