---
title: 'CA2011: setter 内でプロパティを割り当てません'
ms.date: 04/29/2020
ms.topic: reference
f1_keywords:
- CA2011
...
ms.locfileid: "84185017"
---
# <a name="ca2011-do-not-assign-property-within-its-setter"></a>CA2011: setter 内でプロパティを割り当てません
...
> [!NOTE]
> ルール CA2011 は、レガシ分析では使用できません。 これは、 [FxCop アナライザー](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers)バージョン2.9.6 で初めて導入されました。
