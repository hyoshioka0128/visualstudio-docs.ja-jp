---
title: 'CA3003: ファイルパスインジェクションの脆弱性のコードを確認する'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809932"
---
# <a name="ca3003-review-code-for-file-path-injection-vulnerabilities"></a>CA3003: ファイルパスインジェクションの脆弱性のコードを確認する
