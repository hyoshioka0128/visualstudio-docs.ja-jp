---
title: 'CA5366: DataSet に対して XmlReader を使用する XML の読み取り'
...
ms.locfileid: "84185143"
---
# <a name="ca5366-use-xmlreader-for-dataset-read-xml"></a>CA5366: DataSet に対して XmlReader を使用する XML の読み取り
