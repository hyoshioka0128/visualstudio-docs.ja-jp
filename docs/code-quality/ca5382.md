---
title: 'CA5382: ASP.NET Core でセキュリティで保護された cookie を使用する'
...
ms.locfileid: "84185089"
---
# <a name="ca5382-use-secure-cookies-in-aspnet-core"></a>CA5382: ASP.NET Core でセキュリティで保護された cookie を使用する
