---
title: 'CA3009: XML インジェクションの脆弱性のコードを確認する'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809950"
---
# <a name="ca3009-review-code-for-xml-injection-vulnerabilities"></a>CA3009: XML インジェクションの脆弱性のコードを確認する
