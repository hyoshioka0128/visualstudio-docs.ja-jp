---
title: 'CA5392: P/Invoke の DefaultDllImportSearchPaths 属性を使用します。'
...
ms.locfileid: "85289675"
---
# <a name="ca5392-use-defaultdllimportsearchpaths-attribute-for-pinvokes"></a>CA5392: P/Invoke の DefaultDllImportSearchPaths 属性を使用します。
...
[CA5393: unsafe DllImportSearchPath 値を使用しないでください](ca5393.md)
