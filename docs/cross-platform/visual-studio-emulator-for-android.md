...
description: Visual Studio Emulator for Android は Android デバイスをエミュレートするデスクトップ アプリケーションであり、その方法について説明します。
...
Visual Studio Emulator for Android は、Android デバイスをエミュレートするデスクトップ アプリケーションです。 Visual Studio 2015 では非推奨とされており、Visual Studio 2017 と Visual Studio 2019 ではサポートされていません。 代わりに、Google Android エミュレーターを使用することをお勧めします。 Visual Studio 2015 で Visual Studio Emulator for Android を使用する方法を見るには、ドキュメント バージョン セレクターで Visual Studio 2015 を選択してください。
