---
title: ワークフローデザイナー-フローチャートアクティビティデザイナー
description: フローチャートアクティビティデザイナーについて説明します。これには、ワークフロー内のフローチャートを管理するために使用できる、システムによって提供されるアクティビティが含まれています。
