...
description: CodeLens と、それを使用してエディターを離れることなくコードの履歴を調べる方法について説明します。
...
![CodeLens:現在の分岐での変更の検索](../ide/media/codelensfirstbranchconceptual.png)
...
![CodeLens - 変更がマージされた時期の確認](../ide/media/codelensbranchmergedconceptual.png)
