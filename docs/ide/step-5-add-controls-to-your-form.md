...
description: <xref:System.Windows.Forms.PictureBox> コントロールや <xref:System.Windows.Forms.CheckBox> コントロールなどのコントロールをフォームに追加する方法を説明します。
...
1. 新しい **PictureBox** コントロールを選択し、新しい PictureBox コントロール上の黒い三角形を選択して、次のスクリーンショットに示すように、タスク一覧を表示します。
    ...
    ![PictureBox タスク](../ide/media/express_pictureboxtasks.png)<br/>****PictureBox **_ _タスク**
