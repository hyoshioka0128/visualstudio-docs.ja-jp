---
title: ツール ウィンドウを使用してコードの構造を表示する
description: Visual Studio でクラス ビュー、呼び出し階層、オブジェクト ブラウザー、およびコード定義 (C++ のみ) のツール ウィンドウを使用して、クラスとそのメンバーを確認する方法について説明します。
...
ms.locfileid: "96478940"
---
# <a name="view-the-structure-of-code-by-using-different-tool-windows"></a>さまざまなツール ウィンドウを使用してコードの構造を表示する
