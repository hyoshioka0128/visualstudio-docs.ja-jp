...
description: C# プロジェクト デザイナーの [アプリケーション] ページを使用して、プロジェクトのアプリケーション設定とプロパティを指定する方法について説明します。
...
Windows Vista 上で、ユーザー アカウント制御 (UAC) 下でアプリケーションを実行する場合に、マニフェスト生成オプションを選択します。 このオプションには次の値を指定できます。
