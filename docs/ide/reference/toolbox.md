...
![[ツールボックス] ウィンドウ](media/vs-2019/toolbox.png "[ツールボックス] ウィンドウのスクリーンショット")
...
![[ツールボックス] ウィンドウ](media/vs-2019/toolbox-change-dotnet-version.png ".NET バージョンを変更できるダイアログ ボックスのスクリーンショット")
