...
ms.locfileid: "99939826"
---
# <a name="accessibility-products-and-services-from-microsoft"></a>マイクロソフトのアクセシビリティ製品とサービス

Microsoft は、あらゆるユーザーの皆様に使いやすい製品とサービスをお届けできるように努めています。 このページでは、障碍があるユーザーが Microsoft Windows をさらに使いやすくするためのユーザー補助機能、製品、サービスについて説明しています。
