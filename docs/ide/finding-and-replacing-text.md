...
description: '[検索と置換] 機能と、それを使用してパターンのインスタンスを検索および置換する方法について説明します。'
...
:::image type="content" source="media/edit-menu-multiple-carets-find-replace.png" alt-text="Visual Studio のマルチキャレット フライアウト メニューのスクリーンショット":::
