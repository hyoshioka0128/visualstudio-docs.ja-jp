---
title: タスク一覧の使用
description: Visual Studio のタスク一覧を使用して、コードのコメントをより効率的に追跡および使用する方法について説明します。
ms.date: 10/12/2020
ms.topic: how-to
f1_keywords:
- TaskListWindow
...
> [!NOTE]
> 既定のトークンは、C/C++、C#、VB 言語でのみ使用できます。 他のプログラミング言語用に独自のトークンを作成するには、次の手順を行います。
