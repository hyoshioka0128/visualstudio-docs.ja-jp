---
title: プロジェクトにクラス ダイアグラムを追加する (クラス デザイナー)
description: クラスおよび他の型の設計、編集、リファクタリングを行い、クラス ダイアグラムを C#、Visual Basic、または C++ プロジェクトに追加する方法について説明します。
