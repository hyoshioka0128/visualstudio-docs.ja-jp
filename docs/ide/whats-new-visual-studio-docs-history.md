...
ms.locfileid: "96844011"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Visual Studio ドキュメントの新機能に関する履歴

Visual Studio ドキュメントの新機能に関する履歴へようこそ。この記事には、2020 年 11 月より前 (2020 年 7 月以降) のドキュメントに対する主な変更点が含まれます。 最新の新機能については、[Visual Studio の最新情報](whats-new-visual-studio-docs.md)に関するドキュメントを参照してください。
