...
description: 展開と折りたたみのコマンドを使用して、Visual Studio のアウトライン モードで作業する方法について説明します。
...
|[アウトラインの展開/縮小]| ( **Ctrl**+**M** 、 **Ctrl**+**M** ) - 入れ子状に折りたたまれたセクションにカーソルが置かれたときに、最も内側のアウトライン セクションの表示/非表示を切り替えます。|
