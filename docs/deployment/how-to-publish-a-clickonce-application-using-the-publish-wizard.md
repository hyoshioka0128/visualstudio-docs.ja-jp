...
description: 発行ウィザードを使用して、ClickOnce アプリケーションをユーザーが使用できるようにする方法について説明します。これには、使用する公開プロパティも含まれます。
...
2. [**ビルド**] メニューの [  *Projectname* の発行] をクリックします。
