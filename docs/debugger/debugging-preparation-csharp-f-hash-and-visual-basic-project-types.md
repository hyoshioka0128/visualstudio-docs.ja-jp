...
## <a name="in-this-section"></a>このセクションの内容
 ...
 [Windows フォーム アプリケーション](../debugger/debugging-preparation-windows-forms-applications.md): Windows フォーム アプリ プロジェクトについて説明し、デバッグ、既定のデバッグ構成の変更、および [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] の外部でアプリケーションを起動してプロジェクトにアタッチする方法を示します。
