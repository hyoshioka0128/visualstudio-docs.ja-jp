...
description: _CLIENT_BLOCK ブロックに格納されているデータの内容を検証したり、レポートしたりするための Client ブロック用のフック関数を記述します。
...
- [crt_dbg2 サンプル](/previous-versions/b31tft51(v=vs.100))
