...
Microsoft.Net.Component.3.5.DeveloperTools | .NET Framework 3.5 開発ツール | 15.6.27406.0 | 省略可能
...
**説明:** SQL Server データベース プロジェクトをビルドします
...
Microsoft.VisualStudio.Component.FSharp.MSBuild | F# コンパイラ | 15.8.27825.0 | 省略可能
...
Microsoft.VisualStudio.Component.NuGet.BuildTools | NuGet ターゲットとビルド タスク | 15.9.28016.0 | 必須
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# および Visual Basic Roslyn コンパイラ | 15.6.27309.0 | 必須
Component.Android.SDK25 | Android SDK セットアップ (API レベル 25) | 15.9.28107.0 | 省略可能
