...
description: Microsoft ヘルプビューアーのショートカットキーの一覧を参照してください。 ナビゲーション、ウィンドウ管理、およびコンテンツ管理にショートカットキーを使用します。
ms.date: 11/02/2017
ms.topic: reference
helpviewer_keywords:
...
|領域|キー操作|操作|
|----------|---------------|------------|
|汎用アプリケーション|**行間**|編集フィールドを除くすべての場所で、**Enter** の代わりに使用します。|
|汎用アプリケーション|**F1**|現在の UI 要素に関する **ヘルプ** を開きます。|
|汎用アプリケーション|**F11**|全画面表示と通常表示を切り替えます。|
|ツール バー|**バックスペース**<br /><br /> \- または -<br /><br /> **Alt** +**左方向キー**|前のページを表示します。|
...
|トピック|**ショートカット メニュー** キー<br /><br /> または<br /><br /> **Shift** +**F10**|現在の UI 要素のショートカット メニューを表示します。|
