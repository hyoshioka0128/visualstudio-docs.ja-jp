...
<xref:System.Data.Linq.DataContext> メソッドを作成するには、ストアドプロシージャまたは関数を<strong>サーバーエクスプローラーまたは * * データベースエクスプローラー</strong>から**O/R デザイナー**にドラッグします。
