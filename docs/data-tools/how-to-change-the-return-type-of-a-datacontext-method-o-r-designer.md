...
description: オブジェクトリレーショナルデザイナー (O/R デザイナー) でストアドプロシージャまたは関数を削除するときに、DataContext メソッドの戻り値の型を変更する方法について説明します。
...
1. メソッド <xref:System.Data.Linq.DataContext> ペインでメソッドを選択し、削除します。
