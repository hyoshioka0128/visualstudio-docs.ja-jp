---
title: ドラッグ時に作成するコントロールを設定する
description: '[データソース] ウィンドウから WPF デザイナーまたは Visual Studio の Windows フォームデザイナーにドラッグしたときに作成されるコントロールを設定する方法について説明します。'
...
2. **[データ ソース]** ウィンドウで、設定するデータ テーブルまたはオブジェクトを表す項目を選択します。
   ...
   > [!TIP]
   > [ **データソース** ] ウィンドウが開いていない場合は、[ **View**  >  **他の Windows**  >  **データソース** を表示] を選択して開くことができます。
