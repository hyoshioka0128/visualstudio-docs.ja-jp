...
description: カスタム ヒープを使用して割り当てのオーバーヘッドを削減しながら、割り当ての分析用にメモリ プロファイラーに割り当て情報を提供する方法について学習します。
...
次の手順を行うことで、これと同じツールを使用して、カスタム ヒープのメモリ使用量を追跡できます。
