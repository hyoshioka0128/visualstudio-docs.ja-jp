---
title: プロファイラーのコマンド ライン - .NET メモリ データを取得する
description: コマンド ラインからサンプリング メソッドを使用して、スタンドアロンの .NET クライアントのメモリ割り当てとオブジェクトの有効期間データを収集する方法について説明します。
