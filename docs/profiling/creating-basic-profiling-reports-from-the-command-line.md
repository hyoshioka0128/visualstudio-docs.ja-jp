---
title: プロファイルのコマンド ライン - 基本的なレポートの作成
description: .vsp または .vsps プロファイル データ ファイルから .csv (コンマ区切り値) レポートを作成する、VSPerfReport.exe の Summary および CallTrace オプションについて学習します。
