...
description: Visual Studio でフィルターをプロファイル データ ファイルに適用して、パフォーマンス レポート ビューに表示される、またはレポート ファイルにエクスポートされるプロファイル データを制限します。
...
2. フィルターに追加するそれぞれの句について、行の次のフィールドの値を選択または入力します。
    ...
    |**Value**|検索する値を選択または入力します。 フィールドによっては使用可能な値がリスト表示されます。|
