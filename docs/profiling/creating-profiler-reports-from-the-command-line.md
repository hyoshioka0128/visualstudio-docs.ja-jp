---
title: プロファイルのコマンド ライン - レポートの作成
description: VSPerfReport コマンドライン ツールを使用して、プロファイル データ ファイルから .xml または .csv (コンマ区切り値) レポートを作成する方法について学習します。
