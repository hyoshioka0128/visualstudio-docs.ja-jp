...
このトピックでは、XML スキーマ デザイナーのグラフ ビューまたはコンテンツ モデル ビューからダイアグラムを出力する方法について説明します。

## <a name="to-print-diagrams-from-the-xml-schema-designer"></a>XML スキーマ デザイナーからダイアグラムを出力するには

1. Visual Studio で XSD ファイルを開き、いくつかのノードを [XML スキーマ デザイナーのワークスペース](../xml-tools/xml-schema-designer-workspace.md)に追加します。

2. グラフ ビューまたはコンテンツ モデル ビューのデザイン サーフェイスにある **[イメージとしてダイアグラムをエクスポート]** コンテキスト (右クリック) メニュー項目を使用して、XPS ファイルにダイアグラムをエクスポートします。
