...
description: '[ローカル]、[出力]、[ブレークポイント]、[呼び出し履歴]、[ウォッチ] の各ウィンドウなど、XSLT 固有のデバッグ動作を制御する XSLT デバッガーの UI の部分について説明します。'
...
ms.locfileid: "99875121"
---
# <a name="debugger-user-interface-xslt"></a>デバッガー ユーザー インターフェイス (XSLT)

この記事では、デバッガーのウィンドウとダイアログ ボックスについて説明します。 ここでは、XSLT 固有のデバッグ動作を行うユーザー インターフェイスについてのみ説明します。

詳しくは、「[デバッグ用ユーザー インターフェイス リファレンス](../debugger/debugging-user-interface-reference.md)」をご覧ください。
...
詳細については、[XPath 式を評価する](../xml-tools/how-to-evaluate-an-xpath-expression.md)」を参照してください。
...
詳細については、「[[逆アセンブル] ウィンドウを使用する](../debugger/how-to-use-the-disassembly-window.md)」を参照してください。
