...
|[従来のコードをエディターに適応させる](../vs-2015/extensibility/adapting-legacy-code-to-the-editor.md?view=vs-2015)|従来のコードを調整するためのさまざまな方法について説明します (Visual Studio 2010 より前)。|
