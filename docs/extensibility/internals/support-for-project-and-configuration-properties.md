...
description: プロジェクトと構成の拡張プロパティを表示できる、Visual Studio IDE で独自のプロジェクトの種類のプロパティページを提供する方法について説明します。
