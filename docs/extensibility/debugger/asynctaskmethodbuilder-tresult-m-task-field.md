---
description: 遅延初期化されたビルドタスクを表します。
...
ms.locfileid: "102145678"
---
# <a name="asynctaskmethodbuilderlttresultgtm_task-field"></a>AsyncTaskMethodBuilder &lt; TResult &gt; .m_task フィールド
遅延初期化されたビルドタスクを表します。
