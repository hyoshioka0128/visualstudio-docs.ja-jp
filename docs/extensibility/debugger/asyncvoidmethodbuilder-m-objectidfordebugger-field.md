...
ms.locfileid: "99921652"
---
# <a name="asyncvoidmethodbuilderm_objectidfordebugger-field"></a>AsyncVoidMethodBuilder.m_objectIdForDebugger フィールド
このビルダーを一意に識別するためにデバッガーによって使用される、遅延初期化されたオブジェクトを表します。
