...
- [Azure Data Science Virtual Machine](/azure/machine-learning/data-science-virtual-machine/overview) は、他のさまざまなデータ サイエンス ツールと共に Jupyter ノートブックを実行するように事前に構成されています。
