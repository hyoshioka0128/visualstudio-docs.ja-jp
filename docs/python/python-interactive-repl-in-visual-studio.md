...
(第 3 の方法) プロジェクトのスタートアップ ファイルで**対話型**ウィンドウを開くことができます。または、スタンドアロン ファイルの場合は、 **[デバッグ]**  >  **[Python Interactive で \<Project | File> を実行する]** メニュー コマンドを選びます (**Shift**+**Alt**+**F5**)。
