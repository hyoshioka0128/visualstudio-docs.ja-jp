...
( **[ツール]** 、 **[オプション]** 、 **[Python]** 、 **[Conda]** タブの順に選択します)
...
![Visual Studio Tools の [オプション] ダイアログのスクリーンショット。[Python] オプションで [Conda] が選択され、右ペインに [Conda 実行可能ファイル パス] フィールドが表示されています。](media/options-conda.png)
