...
Python 3.5 が正しくインストールされていることを確認し、ターミナルで次のコマンドを実行して pip を最新バージョンにアップグレードする必要があります。
...
NumPy と SciPy をインストールするには、ターミナルで次のコマンドを実行します。
...
MXNet をインストールするには、ターミナルで次のコマンドを実行します。
...
Keras をインストールするには、ターミナルで次のコマンドを実行します。
...
Theano をインストールするには、ターミナルで次のコマンドを実行します。
...
PyTorch をインストールするには、ターミナルで次のコマンドを実行します。
...
Chainer をインストールするには、ターミナルで次のコマンドを実行します。
