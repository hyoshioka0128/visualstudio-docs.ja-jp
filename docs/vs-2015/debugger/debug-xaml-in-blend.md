...
10. Ctrl キーと Shift キーを押しながら B キーを押してプロジェクトをビルドします。  
    ...
    ![Blend for Visual Studio 内で XAML をデバッグする](../debugger/media/blend-debugxaml-xaml.png "blend_debugXAML_XAML")  
...
5. [プロパティ ' Mame ' は名前空間に存在しません。 "をダブルクリックし `https://schemas.microsoft.com/winfx/2006/xaml` ます。 "Mame" の "M" は "N" でなければなりません。 "M" を "N" で置き換えます。 これで、XAML が解析でき、アプリがデザイン サーフェスに表示されます。  
...
## <a name="getting-help"></a>ヘルプの表示  
 アプリのデバッグに関するヘルプが必要な場合 [!INCLUDE[blend_subs](../includes/blend-subs-md.md)] は、 [Windows ストアアプリのコミュニティフォーラム](https://social.msdn.microsoft.com/Forums/windowsapps/home?category=windowsapps) で、問題に関連する投稿を検索するか、質問を投稿できます。
