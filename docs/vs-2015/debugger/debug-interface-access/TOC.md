...
## [作業の開始](getting-started-debug-interface-access-sdk.md)
### [概要](overview-debug-interface-access-sdk.md)
### [.Pdb ファイルの照会](querying-the-dot-pdb-file.md)
## [シンボルとシンボル タグ](symbols-and-symbol-tags.md)
### [シンボルの場所](symbol-locations.md)
### [シンボル型の構文階層](lexical-hierarchy-of-symbol-types.md)
#### [注釈](annotation.md)
#### [ブロック](block.md)
#### [コンパイル単位](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [カスタム (Debug Interface Access SDK)](custom-debug-interface-access-sdk.md)
#### [データ (Debug Interface Access SDK)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [関数 (Debug Interface Access SDK)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [ラベル (Debug Interface Access SDK)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [サンク](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [シンボル型のクラス階層](class-hierarchy-of-symbol-types.md)
...
#### [フレンド (Debug Interface Access SDK)](friend-debug-interface-access-sdk.md)
...
## [リファレンス](debug-interface-access-sdk-reference.md)
### [インターフェイス (Debug Interface Access SDK)](interfaces-debug-interface-access-sdk.md)
...
##### [IDiaEnumSourceFiles::Clon](idiaenumsourcefiles-clone.md)
...
### [列挙型と構造体](enumerations-and-structures.md)
#### [BasicType 列挙型](basictype.md)
#### [CV_access_e 列挙型](cv-access-e.md)
#### [CV_call_e 列挙型](cv-call-e.md)
#### [CV_CFL_LANG 列挙型](cv-cfl-lang.md)
#### [CV_CPU_TYPE_e 列挙型](cv-cpu-type-e.md)
#### [CV_HREG_e 列挙型](cv-hreg-e.md)
#### [DataKind 列挙型](datakind.md)
#### [DiaAddressMapEntry 構造体](diaaddressmapentry.md)
#### [LocationType 列挙型](locationtype.md)
#### [MemoryTypeEnum 列挙型](memorytypeenum.md)
#### [NameSearchOptions 列挙型](namesearchoptions.md)
#### [StackFrameTypeEnum 列挙型](stackframetypeenum.md)
#### [SymTagEnum 列挙型](symtagenum.md)
#### [THUNK_ORDINAL 列挙型](thunk-ordinal.md)
#### [UdtKind 列挙型](udtkind.md)
