...
ベンダー定義型 (コンパイラ固有の型) は、シンボルによって識別され `SymTagCustomType` ます。  
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|`SymTagCustomType`( [Symtagenum 列挙](../../debugger/debug-interface-access/symtagenum.md)値のいずれか) を返します。|  
