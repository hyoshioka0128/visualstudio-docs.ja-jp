---
title: Dia2dump ソースファイル |Microsoft Docs
ms.date: 11/15/2016
...
次の Dia2dump ソースコードは、.pdb ファイルの内容を表示します。 このソースコードは、 [Dia2dump サンプル](../../debugger/debug-interface-access/dia2dump-sample.md)によって使用されます。  
