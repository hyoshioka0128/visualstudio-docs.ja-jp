---
title: デバッガーナビゲーションのサンプルコード (Xaml および C#) |Microsoft Docs
ms.date: 11/15/2016
...
このトピックのコードは、「 [デバッグセッションに移動する (Xaml および C#)](../debugger/navigate-a-debugging-session-in-visual-studio-xaml-and-csharp.md) 」トピックのサンプルファイルです。  
