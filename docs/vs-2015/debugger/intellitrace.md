...
|||  
|-|-|  
|**IntelliTrace を使用してアプリケーションをデバッグする:**<br /><br /> -過去のイベントを表示します。<br />-過去のイベントを含む呼び出し情報を表示します。<br />-IntelliTrace セッションを保存します。<br />-IntelliTrace が収集するデータを制御します。|-   [チュートリアル: IntelliTrace の使用](../debugger/walkthrough-using-intellitrace.md)<br />     [IntelliTrace の機能](../debugger/intellitrace-features.md)<br />[IntelliTrace を構成](https://msdn.microsoft.com/7657ecab-e07e-4b1b-872d-f05d966be37e)-   には<br />-   [デバッグ履歴](../debugger/historical-debugging.md)|  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [再現が困難なバグのある診断トレースデータを含める](https://msdn.microsoft.com/library/944ae9af-5a55-4c58-b520-0108c03b3564)  
