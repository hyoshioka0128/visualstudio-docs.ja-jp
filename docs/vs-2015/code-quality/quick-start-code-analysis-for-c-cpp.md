...
- [プロジェクトの規則セットを構成する](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_ConfigureRuleSets)  
  
- [コード分析の実行](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_Run)  
  
- [コード分析警告の分析と解決](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_Analyze)  
  
- [コード分析警告の抑制](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_Suppress)  
  
- [コード分析警告用の作業項目の作成](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_Creating_work_items_for_code_analysis_warnings)  
  
- [コード分析結果の検索とフィルター処理](../code-quality/quick-start-code-analysis-for-c-cpp.md#BKMK_Search)  
  
## <a name="BKMK_ConfigureRuleSets"></a>プロジェクトの規則セットを構成する  
...
4. [**この規則セットを実行**する] の一覧で、次のいずれかの操作を行います。  
    ...
    - 参照\<を選択してください.. **.>** 、一覧に含まれていない既存のカスタム規則セットを指定します。  
...
## <a name="BKMK_Analyze"></a>コード分析警告の分析と解決  
 ...
 問題を理解した後は、コード内で解決できます。 コード分析を再度実行して、[コード分析] ウィンドウに警告が表示されないこと、および修正によって新しい警告が発生しないことを確認します。  
...
## <a name="BKMK_Creating_work_items_for_code_analysis_warnings"></a>コード分析警告用の作業項目の作成  
