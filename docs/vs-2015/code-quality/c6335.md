...
```  
 ...
 詳細については、「 [CreateProcess 関数](https://go.microsoft.com/fwlink/?LinkId=181206)と[CloseHandle 関数](https://go.microsoft.com/fwlink/?LinkId=181207)」を参照してください。
