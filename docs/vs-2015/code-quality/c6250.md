...
警告 C6250: MEM_RELEASE フラグを指定せずに \<関数 > VirtualFree を呼び出すと、メモリが解放される場合がありますが、アドレス記述子 (VADs) は使用できません。アドレス空間リークの結果  
 ...
 詳細については、「 [VirtualAlloc](https://go.microsoft.com/fwlink/?LinkId=181201)と[VirtualFree](https://go.microsoft.com/fwlink/?LinkId=181202)」を参照してください。  
