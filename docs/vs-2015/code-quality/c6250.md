...
警告 C6250: MEM_RELEASE フラグを指定せずに \<関数 > VirtualFree を呼び出すと、メモリが解放される場合がありますが、アドレス記述子 (VADs) は使用できません。アドレス空間リークの結果  
 ...
 詳細については、「 [VirtualAlloc](https://msdn.microsoft.com/library/aa366887.aspx)と[VirtualFree](https://msdn.microsoft.com/library/aa366892.aspx)」を参照してください。  
