...
- [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]CppDemo という名前のソリューション。  
...
7. [ **ソリューション名** ] テキストボックスに、「 **cppdemo**」と入力します。  
...
4. 次のコードをコピーし、エディターの **バグ .cpp** ファイルに貼り付け [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ます。  
...
8. 次のコードをコピーし、エディターのバグ .h ファイルに貼り付け [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ます。  
...
4. 次のコードをコピーし、エディターの**コメント .h**ファイルに貼り付けます。 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]  
...
8. 次のコードをコピーし、エディターの **コメント .cpp** ファイルに貼り付け [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ます。  
