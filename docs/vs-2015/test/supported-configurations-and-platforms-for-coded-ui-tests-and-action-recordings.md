...
## <a name="supported-configurations"></a>サポートされる構成
...
|.NET|.NET 2.0、3.0、3.5、4、および 4.5。 **注:** [!INCLUDE[TCMext](../includes/tcmext-md.md)] と Visual Studio では、両方とも .net 4 を操作する必要があります。 ただし、一覧のバージョンの .NET を使用して開発されたアプリケーションはサポートされます。|
