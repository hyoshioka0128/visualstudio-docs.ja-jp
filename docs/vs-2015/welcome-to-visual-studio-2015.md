...
> [Visual Studio 2017](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes) のリリース ノートについては、こちらをクリックしてください。
 ...
 Visual Studio 2015 は、「 [Visual Studio のダウンロード](https://visualstudio.microsoft.com/vs/older-downloads/)」からダウンロードしてインストールできます。 インストールプロセスの詳細については、「 [Visual Studio 2015 のインストール](./install/install-visual-studio-2015.md)」を参照してください。
...
## <a name="extend-visual-studio"></a>Visual Studio を拡張する
 ...
 [.NET Compiler Platform (Roslyn)](https://github.com/dotnet/Roslyn)を使用して、独自のコードアナライザーとコードジェネレーターを作成することができます。 
...
- [クロスプラットフォームモバイル開発用 c++](./cross-platform/visual-cpp-for-cross-platform-mobile-development.md): c++ の共有コードライブラリとアプリ
...
### <a name="test-your-app"></a>アプリをテストする
 ...
 アプリの手動テストと自動テストを計画、作成、実行します。 テスト計画、スイート、テスト ケース、テスト結果は、Visual Studio Team Services でクラウドに、または Team Foundation Server でオンプレミスのサーバーに格納されます。 [アプリケーションのテスト](https://msdn.microsoft.com/library/73baa961-c21f-43fe-bb92-3f59ae9b5945)について学びます。
...
- [C の新機能#](https://msdn.microsoft.com/library/9f18dc26-27fa-4603-a639-b573f07a117b)

- [.NET Framework の新機能](https://msdn.microsoft.com/library/1d971dd7-10fc-4692-8dac-30ca308fc0fa)

- [Azure DevOps Server の新機能](/azure/devops/server/whats-new)

- [C++ の新機能](https://docs.microsoft.com/previous-versions/hh409293(v=vs.140))

- [Visual Basic の新機能](https://msdn.microsoft.com/library/d7e97396-7f42-4873-a81c-4ebcc4b6ca02)

- [JavaScript の新機能](https://docs.microsoft.com/visualstudio/javascript/javascript-in-visual-studio?view=vs-2015#whats-new-in-javascript)
...
- [Visual Studio プロジェクトの移植、移行、アップグレード](./porting/porting-migrating-and-upgrading-visual-studio-projects.md)
