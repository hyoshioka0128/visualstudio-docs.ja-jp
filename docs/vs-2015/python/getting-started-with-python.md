...
Python をインストールするには、にアクセス [https://www.python.org/download/](https://www.python.org/download/) します。
...
- 使い方ガイド:
  ...
  - [ストレージ テーブル](https://azure.microsoft.com/develop/python/how-to-guides/table-service/)  
  - [Service Bus キュー](https://azure.microsoft.com/develop/python/how-to-guides/service-bus-queues/)
  - [Service Bus のトピック/サブスクリプション](https://azure.microsoft.com/develop/python/how-to-guides/service-bus-topics/) 
...
[PTVS でのはじめに: Visual Studio](../python/getting-started-with-ptvs-setting-up-visual-studio.md) 
 の設定[PTVS でのはじめに: コーディングの開始 (プロジェクト)](../python/getting-started-with-ptvs-start-coding-projects.md) 
[PTVS でのはじめに: コード](../python/getting-started-with-ptvs-editing-code.md) 
 の編集[PTVS を使用したはじめに: デバッグ](../python/getting-started-with-ptvs-debugging.md) 
[PTVS: Interactive Python](../python/getting-started-with-ptvs-interactive-python.md) 
 を使用したはじめに[PTVS でのはじめに: Azure での Web サイトの構築](../python/getting-started-with-ptvs-building-a-website-in-azure.md)
