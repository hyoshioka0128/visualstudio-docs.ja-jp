...
- [プロジェクトを作成するときのバージョンのターゲット設定](../ide/how-to-target-a-version-of-the-dotnet-framework.md#bkmk_new)

- [ターゲット バージョンの変更](../ide/how-to-target-a-version-of-the-dotnet-framework.md#bkmk_existing)

## <a name="targeting-a-version-when-you-create-a-project"></a><a name="bkmk_new"></a> プロジェクト作成時にバージョンを対象として設定
...
## <a name="changing-the-target-version"></a><a name="bkmk_existing"></a> ターゲットバージョンの変更
...
## <a name="see-also"></a>参照
 [Visual Studio のマルチターゲットの概要](../ide/visual-studio-multi-targeting-overview.md) [.NET Framework ASP.NET Web プロジェクトのマルチターゲットの](https://msdn.microsoft.com/library/8b8145a9-62f6-4fc4-8a83-47b0487cbe76)[トラブルシューティング .NET Framework エラーを対象](../msbuild/troubleshooting-dotnet-framework-targeting-errors.md)とする[アプリケーションページ、プロジェクトデザイナー (C#)](../ide/reference/application-page-project-designer-csharp.md) [アプリケーションページ、プロジェクトデザイナー (Visual Basic)](../ide/reference/application-page-project-designer-visual-basic.md)プロジェクトの[構成](https://msdn.microsoft.com/library/a1489abb-6294-4f8f-b71f-2cb126393526)[方法: ターゲットフレームワークおよびプラットフォームのツールセットを変更](https://msdn.microsoft.com/library/031b1d54-e6e1-4da7-9868-3e75a87d9ffe)する
