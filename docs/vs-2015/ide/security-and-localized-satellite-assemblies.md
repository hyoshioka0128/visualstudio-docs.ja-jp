...
## <a name="see-also"></a>参照
 [アセンブリのセキュリティに関する考慮事項](https://msdn.microsoft.com/library/1b5439c1-f3d5-4529-bd69-01814703d067)[主要なセキュリティの概念](https://msdn.microsoft.com/library/3cfced4f-ea02-4e66-ae98-d69286363e98)アプリケーション[をローカライズする .NET Framework に基づく国際対応](../ide/introduction-to-international-applications-based-on-the-dotnet-framework.md) [Localizing Applications](../ide/localizing-applications.md)アプリケーションの概要アプリケーションの[グローバライズとローカライズ](../ide/globalizing-and-localizing-applications.md)
