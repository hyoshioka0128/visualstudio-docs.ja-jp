...
- チュートリアルの次の手順に進むには、「 [手順 11: プログラムを実行し、その他の機能を試す](../ide/step-11-run-your-program-and-try-other-features.md)」を参照してください。

- チュートリアルの前の手順に戻るには、「 [手順 9: レビュー、コメントの作成、およびコードのテスト](../ide/step-9-review-comment-and-test-your-code.md)」を参照してください。
