...
- NuGet は、オープン ソースのパッケージ管理システムであり、ライブラリをプロジェクトのソリューションに組み込むプロセスを簡略化します。 詳細については、[NuGet の概要](https://docs.microsoft.com/nuget/what-is-nuget)に関するページを参照してください。
