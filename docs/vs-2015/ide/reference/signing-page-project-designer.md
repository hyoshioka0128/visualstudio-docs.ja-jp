 ...
 **[厳密な名前のキーファイルを選択し** てください] の一覧では、アセンブリの署名に使用される新しいまたは既存の厳密な名前のキーファイルを指定できます。 **[\<Browse...>]** を選択して、既存のキー ファイルを選択します。
...
## <a name="see-also"></a>参照
 [プロジェクトのプロパティリファレンス](../../ide/reference/project-properties-reference.md)[アセンブリとマニフェスト署名の管理](../../ide/managing-assembly-and-manifest-signing.md)[マネージアプリケーションの厳密な名前の署名](https://msdn.microsoft.com/5fef3490-c519-4363-94fd-8b1ad260dab5)[方法: アプリケーションマニフェストおよび配置マニフェストに署名](../../ide/how-to-sign-application-and-deployment-manifests.md)する方法:[アセンブリに署名する (Visual Studio)](https://msdn.microsoft.com/f468a7d3-234c-4353-924d-8e0ae5896564) [方法: 厳密な名前](https://msdn.microsoft.com/library/2c30799a-a826-46b4-a25d-c584027a6c67)の厳密な名前[付きアセンブリ](https://msdn.microsoft.com/library/d4a80263-f3e0-4d81-9b61-f0cbeae3797b)を使用してアセンブリに署名する
