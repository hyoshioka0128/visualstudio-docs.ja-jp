 ...
 **アクティブでないコードブロックの表示** 宣言によって非アクティブになっているコード `#ifdef` は、識別しやすいように異なる方法で色分けされています。
 ...
 **かっこをインデント** する関数やループなどのコードブロックを開始した後に enter キーを押すと、中かっこをどのように揃えるかを構成でき `for` ます。 中かっこは、コード ブロックの最初の文字位置に合わせて、またはインデント位置に合わせて配置されます。
