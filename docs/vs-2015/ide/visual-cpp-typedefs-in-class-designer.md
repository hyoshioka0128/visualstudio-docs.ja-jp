...
## <a name="see-also"></a>参照
 [Visual C++ コードの操作 (クラスデザイナー)](../ide/working-with-visual-cpp-code-class-designer.md) [(notinbuild) typedef 指定子](https://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1)
