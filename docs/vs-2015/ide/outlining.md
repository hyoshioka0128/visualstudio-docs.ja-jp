...
|ブロックを折りたたむ:\<logical boundary>|(Visual C++) カーソルを含む関数内の領域を折りたたみます。 たとえば、カーソルがループの内部にある場合、そのループは非表示になります。|
|すべてを折りたたむ:\<logical structures>|(Visual C++) 関数内のすべての構造体を折りたたみます。|
