...
### <a name="team"></a><a name="bkmk_team"></a>グループ
...
## <a name="microsoft-sql-server-data-tools-table-designer"></a><a name="bkmk_TableDesigner"></a> Microsoft SQL Server Data Tools、テーブル デザイナー
