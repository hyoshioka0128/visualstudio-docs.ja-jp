...
6. ツール ボックスの **[コンテナー]** カテゴリから `TableLayoutPanel` コントロールをフォームにドラッグし、次のプロパティを設定します。
   ...
   6. タスク メニューで、**[行および列の編集]** をクリックして、**[列と行のスタイル]** ウィンドウを開きます。 各列を選択し、**[パーセント]** をクリックして、各列の幅を全体の幅の 25% に設定します。 ウィンドウの上部にあるドロップダウン ボックスから **[行]** を選択し、各行の高さを 25% に設定します。 終了したら、**[OK]** ボタンをクリックします。
...
- チュートリアルの次の手順に進むには、「 [手順 2: ランダムなオブジェクトを追加する」および「アイコンの一覧](../ide/step-2-add-a-random-object-and-a-list-of-icons.md)」を参照してください。
