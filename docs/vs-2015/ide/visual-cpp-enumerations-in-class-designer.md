...
## <a name="see-also"></a>参照
 [Visual C++ コード (クラスデザイナー)](../ide/working-with-visual-cpp-code-class-designer.md) [列挙型](https://msdn.microsoft.com/library/081829db-5dca-411e-a53c-bffef315bcb3)の使用
