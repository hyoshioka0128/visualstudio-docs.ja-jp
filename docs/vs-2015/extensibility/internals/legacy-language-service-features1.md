...
Managed package framework (MPF) 言語サービスでは、 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 構文の強調表示、IntelliSense、ブレークポイントの検証など、1つまたは複数の機能をサポートできます。 各機能を他の機能とは別に実装することもできますが、構文の強調表示を除き、スキャナーだけを必要とするパーサーとスキャナーが必要です。  
...
## <a name="related-sections"></a>関連項目  
 ...
 MPF ベースの言語サービスをに登録するために必要な手順について説明し [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ます。  
