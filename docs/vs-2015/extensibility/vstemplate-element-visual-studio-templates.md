...
|`Version`|テンプレートのバージョン番号を指定します。 およびの [!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)] テンプレート [!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)] `Version` の属性値は `3.0.0` です。|  
