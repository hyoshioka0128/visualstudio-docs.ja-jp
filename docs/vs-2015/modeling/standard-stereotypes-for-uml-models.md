...
## <a name="the-standard-profiles"></a>標準プロファイル
 次のプロファイルは、インストールするとすぐに、サポートされているエディションの Visual Studio で使用できます。

|プロファイル|目的|
|-------------|-------------|
|[UML Standard Profile L2](#L2)|要素またはリレーションシップに関する追加情報を追加するために使用できる、標準のステレオタイプのセット。|
|[UML Standard Profile L3](#L3)|要素またはリレーションシップに関する追加情報を追加するために使用できる、標準のステレオタイプのセット。|
...
### <a name="uml-standard-profile-l2"></a><a name="L2"></a> UML 標準プロファイル L2
...
|create|依存関係|クライアント クラスが、サプライヤーのインスタンスを作成します。|
|create|Message|送信者が受信者を作成します。|
|create|操作|この操作は、コンストラクターです。|
|derive|依存関係|クライアント要素が、サプライヤーから完全または部分的に計算されます。|
|destroy|操作|この操作は、インスタンスを破棄します。|
|ドキュメント|アーティファクト|ソースまたは実行可能ファイルではない «File»。|
|エンティティ|コンポーネント|コンポーネントは、ビジネスの概念を表します。|
|executable|アーティファクト|実行可能な «file»。|
|file|アーティファクト|物理ファイル。|
...
|script|アーティファクト|解釈可能な «file»。|
|[Send]|依存関係|ソースの操作が、ターゲットのシグナルを送信します。|
|サービス (service)|コンポーネント|ステートレスなコンポーネント。|
|source|アーティファクト|コンパイル可能な «file»。|
...
|型|クラス|オブジェクトの振る舞いを、それがどのように実装されているかを示さずに指定します。 オブジェクトは、仕様に準拠している場合、type のメンバーです。|
|utility|クラス|静的関数のコレクション。 クラスにはインスタンスが存在しません。|

### <a name="uml-standard-profile-l3"></a><a name="L3"></a> UML 標準プロファイル L3
...
## <a name="c-profile"></a><a name="NetProfile"></a> C# プロファイル
...
|ステレオタイプ|適用対象|プロパティ|
|----------------|----------------|----------------|
|**C# クラス**|UML クラス<br /><br /> コンポーネント|**Clr 属性**<br /><br /> **Is Partial**<br /><br /> **シールされている**<br /><br /> **Is Static**<br /><br /> **Is Unsafe**<br /><br /> **パッケージの可視性**|
|**C# struct**|UML クラス<br /><br /> コンポーネント|**Clr 属性**<br /><br /> **Is Partial**<br /><br /> **Is Unsafe**<br /><br /> **パッケージの可視性**|
|**C# グローバル メンバー**|UML クラス<br /><br /> コンポーネント|**Clr 属性**|
|**C# インターフェイス**|UML インターフェイス|**Clr 属性**<br /><br /> **Is Partial**<br /><br /> **パッケージの可視性**|
|**C# enum**|UML 列挙型|**ClrAttributes**<br /><br /> **基本型**|
|**C# namespace**|UML パッケージ|**Clr 属性**<br /><br /> **Base Name**<br /><br /> **名前空間の使用**|
