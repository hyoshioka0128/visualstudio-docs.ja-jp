...
## <a name="testing-the-language"></a>言語のテスト
 次の手順では、の新しいインスタンスで DSL デザイナーをビルドして実行し、 [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 追跡プロパティが正常に機能していることを確認します。
...
2. **[デバッグ]** メニューの **[デバッグの開始]** をクリックします。
     ...
     の実験用ビルドでは、 [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 空のテストファイルを含む **デバッグ** ソリューションが開きます。
