...
2. アプリケーションの[主要な機能領域またはコンポーネントを表すレイヤーを定義](#CreateLayers)します。 これらのレイヤーには、その機能に合わせて "プレゼンテーション" や "サービス" などの名前を付けます。 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ソリューションを使用している場合は、プロジェクト、名前空間、ファイルなど、各レイヤーを*成果物*のコレクションに関連付けることができます。
