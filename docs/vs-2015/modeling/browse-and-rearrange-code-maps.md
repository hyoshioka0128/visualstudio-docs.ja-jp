...
|**To**|**次の手順を実行します。**|
|------------|-----------------------------|
|グラフ全体の依存関係のフローを特定の方向に配置します。 これは、コードのアーキテクチャ レイヤーを確認するのに役立ちます。|マップのツールバーで、 **[レイアウト]** を選択し、次のようにします。<br /><br /> **上から下**へ -   ![のグラフボタン](../modeling/media/topbottomgraphbutton.gif "TopBottomGraphButton")<br />**下から上へ**-   ![のグラフボタン](../modeling/media/bottomtopgraphbutton.gif "下の Topgraphbutton")<br />**左**から右へ -   ![レイアウトボタン](../modeling/media/leftrightgraphbutton.gif "LeftRightGraphButton")<br />**右**から左への -   の![グラフボタン](../modeling/media/rightleftgraphbutton.gif "右左 Graphbutton")|
...
|**To**|**マップのツールバーで、レイアウト、詳細設定 の順に選択し、**|
|------------|----------------------------------------------------------------------|
