...
---
# <a name="uml-use-case-diagrams-guidelines"></a>UML ユースケース図:ガイドライン
...
- システムの範囲。
  ...
  ユース ケースの記述では、システムが運用されるドメインに関連するいくつかの用語 ("販売"、"メニュー"、"顧客" など) を使用します。 これらの用語とその関係を明確に定義することが重要になりますが、これは、UML クラス図を利用することで可能になります。 詳細については、「[UML Class Diagrams:ガイドライン](../modeling/uml-class-diagrams-guidelines.md)。
...
2. **アクター**をツールボックスから図にドラッグします (システム境界の外側に配置します)。
    ...
    - 各アクターの名前を変更します。 次に例を示します。**顧客、レストラン、クレジットカード機関。**

3. ツールボックス から **ユースケース** を適切なシステムにドラッグします。

    - ユース ケースは、アクターがこのシステムを利用して実行するアクティビティを表します。

    - 各アクティビティの名前を、アクターが理解できるタイトルに変更します。 コードに関係するタイトルは使用しないでください。 次に例を示します。料理**の注文、料理の支払い、料理の配送**。
...
- ユース ケースをプロジェクト内の別の図 (1 つまたは複数) にリンクする。
  ...
  - アクティビティ図は、ループ、分岐、および並列スレッドを含むより複雑なプロセスを説明するのに便利です。 プロセスの個々の部分の間のデータ フローを示すこともできます。 詳細については、「[UML アクティビティ図」を参照してください。ガイドライン](../modeling/uml-activity-diagrams-guidelines.md)。

  - シーケンス図は、さまざまなアクター間で行われる一連の複雑な対話を説明するのに便利です。 シーケンス図を使用して、各ユース ケースに対してシステム内部で発生する処理を示すこともできます。 詳細については、「UML シーケンス図の [」を参照してください。ガイドライン](../modeling/uml-sequence-diagrams-guidelines.md)。
...
- アクティビティ図内のアクションに、包含される側のユース ケースと同じ名前が付いている。
  ...
  詳細については、「[UML アクティビティ図」を参照してください。ガイドライン](../modeling/uml-activity-diagrams-guidelines.md)。
...
## <a name="see-also"></a>関連項目
 UML シーケンス図 [[モデルユーザー要件](../modeling/model-user-requirements.md):Uml ユースケース図 [[uml モデルおよび図を編集](../modeling/edit-uml-models-and-diagrams.md)](../modeling/uml-sequence-diagrams-guidelines.md) ガイドラインを次に示します。UML クラス図のリファレンス](../modeling/uml-use-case-diagrams-reference.md) [:UML コンポーネント図のリファレンス](../modeling/uml-class-diagrams-reference.md) [:UML アクティビティ図のリファレンス](../modeling/uml-component-diagrams-reference.md) [:[ビデオ](../modeling/uml-activity-diagrams-guidelines.md) ガイドライン:ユースケースへの特徴の整理](https://channel9.msdn.com/blogs/clinted/uml-with-vs-2010-part-2-organizing-features-into-use-cases)
