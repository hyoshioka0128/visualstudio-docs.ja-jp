---
title: アプリ&#39;s アーキテクチャをモデル化するMicrosoft Docs
ms.date: 11/15/2016
...
## <a name="high-level-design"></a><a name="Structure"></a> 高レベルの設計
...
## <a name="understanding-the-requirements"></a><a name="Requirements"></a> 要件について
...
## <a name="architectural-patterns"></a><a name="BigDecisions"></a> アーキテクチャパターン
...
## <a name="components-and-their-interfaces"></a><a name="Components"></a> コンポーネントとそのインターフェイス
...
### <a name="components"></a>コンポーネント
 ...
 ![パートを示す UML コンポーネント図](../modeling/media/uml-barecomponent.png "UML_BareComponent")
...
## <a name="interactions-between-components"></a><a name="Interactions"></a> コンポーネント間の相互作用
 このセクションの主要な推奨事項を次に示します。
...
### <a name="data-model-of-the-components-and-interfaces"></a><a name="Data"></a> コンポーネントとインターフェイスのデータモデル
...
## <a name="design-patterns"></a><a name="Patterns"></a> 設計パターン
