...
|[チュートリアル: リアルな3-d ビリヤードボールの作成](../designers/walkthrough-creating-a-realistic-3-d-billiard-ball.md)|複数のシェーダー方法とテクスチャ リソースとを組み合わせて、リアルなビリヤード ボール シェーダーを作成する方法を示します。|
