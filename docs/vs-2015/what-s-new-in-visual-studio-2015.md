...
### <a name="cross-platform-apps-and-libraries-for-native-c"></a>ネイティブ C++ 用のクロス プラットフォーム アプリおよびライブラリ
 ...
 クロスプラットフォーム C++ の概要については、「 [Visual C++ を使用したクロスプラットフォームモバイルアプリのビルド](./misc/build-cross-platform-mobile-apps-with-visual-cpp.md)」を参照してください。
...
4. Salesforce
   ...
   ![[接続済みサービスの追加] ダイアログ](./ide/media/vs2015-addconnectedservicedialog.png "VS2015_AddConnectedServiceDialog")
...
### <a name="title-case-menus"></a>メニューの先頭文字の大文字指定
 ...
 ![Visual Studio 2015 メニューの先頭文字の大文字指定コマンド](./ide/media/vs2015-mainmenu.png "VS2015_MainMenu")
...
- **アーキテクチャエクスプローラー**。 アーキテクチャ エクスプローラーを使ってダイアグラムを作成できなくなりました。 しかし、ソリューション エクスプローラーを使って引き続き作成できます。
...
### <a name="report-crashes-unresponsive-and-performance-issues"></a>クラッシュ、応答しない、およびパフォーマンスの問題を報告する
 気になる点のちょっとしたメモでは済ませられない問題が発生するかもしれません。 Visual Studio が応答を停止したり、クラッシュしたり、別のパフォーマンスの問題が発生したりすると、改善点を送信した後に表示されるダイアログを使用して、再現手順、クラッシュダンプ、トレースファイルを簡単に共有できます。
