...
## <a name="installing-and-uninstalling"></a><a name="Installing"></a> インストールとアンインストール  
 インストール  
...
## <a name="system-requirements-and-backward-compatibility"></a><a name="Requirements"></a> システム要件と旧バージョンとの互換性  
...
## <a name="networking-in-the-visual-studio-emulator-for-android"></a><a name="Networking"></a> Visual Studio Emulator for Android でのネットワーク  
...
## <a name="configure-the-visual-studio-emulator-for-android"></a><a name="Configuring"></a> Visual Studio Emulator for Android の構成  
...
## <a name="features-that-you-can-test-in-the-emulator"></a><a name="FeaturesTest"></a> エミュレーターでテストできる機能  
...
## <a name="features-that-you-cant-test-in-the-emulator"></a><a name="FeaturesNonTest"></a> エミュレーターでテストできない機能  
