...
1. 現在のワークフロー プロジェクトに新しいカスタム アクティビティを追加します。 [!INCLUDE[crabout](../includes/crabout-md.md)] 新しいカスタムアクティビティをプロジェクトに追加する方法については、「 [方法: ワークフロープロジェクトに新しい項目を追加](../workflow-designer/how-to-add-a-new-item-to-a-workflow-project.md)する」を参照してください。
