---
title: .NET 3.0 または .NET 3.5 Framework を対象とするワークフローアプリケーションの開発 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="related-sections"></a>関連セクション
 [Windows Workflow Foundation プログラミングガイド](https://go.microsoft.com/fwlink?LinkID=65012)