...
|**キャンセル ハンドラーの表示**|このメニューまたはタブのオプションビューを選択すると、選択したアクティビティに関連付けられている [CancellationHandlerActivity](https://msdn2.microsoft.com/library/system.workflow.componentmodel.cancellationhandleractivity.aspx) が表示されます。|
|**エラー ハンドラーの表示**|このメニューまたはタブのオプションビューを選択すると、選択したアクティビティに関連付けられている [FaultHandlersActivity](https://msdn2.microsoft.com/library/system.workflow.componentmodel.faulthandlersactivity.aspx) が表示されます。|
|**補正ハンドラの表示**|このメニューまたはタブのオプションビューを選択すると、選択した[TransactionScopeActivity](https://msdn2.microsoft.com/library/system.workflow.componentmodel.transactionscopeactivity.aspx)に関連付けられている[CompensationHandlerActivity](https://msdn2.microsoft.com/library/system.workflow.componentmodel.compensationhandleractivity.aspx)が表示されます。|
|**イベント ハンドラの表示**|このメニューまたはタブのオプションビューを選択すると、選択した[EventHandlingScopeActivity](https://msdn2.microsoft.com/library/system.workflow.activities.eventhandlingscopeactivity.aspx)に関連付けられている[EventHandlersActivity](https://msdn2.microsoft.com/library/system.workflow.activities.eventhandlersactivity.aspx)が表示されます。|
