---
title: 従来のワークフロープロジェクトを作成する |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>参照
 [シーケンシャルワークフロービュー (レガシ)](../workflow-designer/sequential-workflow-views-legacy.md) [Visual Studio ワークフローウィンドウ (レガシ)](../workflow-designer/visual-studio-workflow-windows-legacy.md)