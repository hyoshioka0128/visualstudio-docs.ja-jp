---
title: Visual Studio ワークフローウィンドウ (レガシ) |Microsoft Docs
ms.date: 11/15/2016
...
|デバッグ ウィンドウ|[ **スレッド**]、[ **呼び出し履歴**]、[ **ブレークポイント**]、[ **ローカルツール**]、[ **ウォッチ] ツール** ウィンドウなど、標準の Visual Studio デバッグウィンドウ。|
