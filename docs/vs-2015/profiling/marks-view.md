...
## <a name="see-also"></a>参照  
 [パフォーマンスレポートの概要](../profiling/performance-report-overview.md)   
 [<PAVE_OVER> 方法: プロファイリングマークを構成する](https://msdn.microsoft.com/library/65a23880-e5e8-4d5a-82b3-6498b9ef8975)   
 [<PAVE_OVER> 方法: プロファイラーデータファイルにマークを挿入する](https://msdn.microsoft.com/library/856bfc81-a60f-42e5-a9bc-71b986c1e09d)   
