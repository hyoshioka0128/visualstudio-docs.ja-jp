...
## <a name="run-the-html-ui-responsiveness-tool"></a><a name="RunningProfiler"></a> HTML UI の応答性ツールの実行  
...
## <a name="isolate-an-issue"></a><a name="IsolateAnIssue"></a> 問題の特定  
...
## <a name="analyze-data"></a><a name="AnalyzeData"></a> データの分析  
...
## <a name="save-a-diagnostic-session"></a><a name="SaveSession"></a> 診断セッションの保存  
...
## <a name="additional-information"></a><a name="Tips"></a> 追加情報  
