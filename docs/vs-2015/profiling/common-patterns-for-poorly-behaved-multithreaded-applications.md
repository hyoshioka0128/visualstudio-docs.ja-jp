...
## <a name="lock-contention-and-serialized-execution"></a>ロック競合とシリアル化実行  
 ...
 詳細については、MSDN ブログ Web サイトの Hazim Shafi のブログ「[Parallel Performance Tools For Windows](https://docs.microsoft.com/archive/blogs/hshafi/)」(Windows 用並列パフォーマンス ツール) の「Performance Pattern 1: Identifying Lock Contention」(パフォーマンス パターン 1: ロック競合の特定) を参照してください。  
...
## <a name="inefficient-io"></a>非効率的な I/O  
 ![非効率的な I&#47;O](../profiling/media/inefficient-io.png "Inefficient_IO")  
