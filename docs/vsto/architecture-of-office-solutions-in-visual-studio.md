...
description: Visual Studio の Microsoft Office 開発者ツールを使用して作成されたソリューションとその機能について説明します。
...
エンドユーザーのコンピューターで VSTO アドインを検出して読み込むために必要なレジストリキーについて説明します。
