...
> [!NOTE]
> Office 開発ツールは、Visual Studio の一部のエディションに付属しています。 詳細については、「 [Office ソリューションを開発するためのコンピューターの構成](../vsto/configuring-a-computer-to-develop-office-solutions.md)」を参照してください。

## <a name="document-level-customizations"></a><a name="DocLevel"></a> ドキュメントレベルのカスタマイズ
...
> [!NOTE]
> マネージコード拡張機能を参照する Word テンプレートは、グローバル VSTO アドインとして使用できません。Word のスタートアップディレクトリからテンプレートが読み込まれる場合、アセンブリは呼び出されません。 詳細については、「 [グローバルテンプレートと Excel アドイン (.xla ファイル) の制限事項](#Limitations)」を参照してください。
...
## <a name="vsto-add-ins"></a><a name="AppLevel"></a> VSTO アドイン
...
## <a name="limitations-of-global-templates-and-excel-add-ins-xla-files"></a><a name="Limitations"></a> グローバルテンプレートと Excel アドイン (.xla ファイル) の制限事項
