...
description: Visual Studio で導入された変更について、.NET Framework 4 以降を対象とする Office プロジェクトのデザインについて説明します。
