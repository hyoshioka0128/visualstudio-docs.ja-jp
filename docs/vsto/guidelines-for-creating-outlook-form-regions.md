...
## <a name="design-adjoining-form-regions-for-the-reading-pane"></a><a name="ReadingPane"></a> 閲覧ウィンドウの隣接フォーム領域をデザインする
...
## <a name="use-optimal-icon-sizes"></a><a name="UsingOptimal"></a> 最適なアイコンサイズを使用する
