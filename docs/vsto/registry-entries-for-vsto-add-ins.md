...
>
>詳細について[は、レジストリの32ビットおよび64ビットアプリケーションデータ](https://docs.microsoft.com/windows/win32/sysinfo/32-bit-and-64-bit-application-data-in-the-registry)を参照してください。
