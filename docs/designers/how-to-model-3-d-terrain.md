...
description: モデル エディターを使用して、平面を分割して別の面を作成し、それらの頂点を操作することによって 3D 地形モデルを作成する方法について説明します。
...
1. 動作する 3D モデルを作成する プロジェクトにモデルを追加する方法に関する詳細については、「[モデル エディター](../designers/model-editor.md)」の「作業の開始」セクションを参照してください。
