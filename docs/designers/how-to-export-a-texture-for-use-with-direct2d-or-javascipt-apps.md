---
title: Direct2D と JavaScript アプリケーション用のテクスチャをエクスポートする
description: イメージ コンテンツ パイプラインでは、Direct2D アプリと JavaScript で作成された UWP アプリで使用される Direct2D 内部レンダリングと互換性のあるテクスチャが生成されます。
