...
description: さまざまなロード モデリング オプションを使用して、ロード テストの対象となる Web サイトまたはアプリケーションの実際の使用状況をより正確に予測します。
...
### <a name="percentage-based-on-tests-started"></a><a name="BasedOnTestsStarted"></a> 開始されるテストに基づく割合
...
### <a name="percentage-based-on-virtual-users"></a><a name="PercentageBasedonVirtualUsers"></a> 仮想ユーザーに基づく割合
...
### <a name="pacing-test-mix"></a><a name="PacingTestMix"></a> テスト ミックスのペース配分
...
### <a name="sequential-order"></a><a name="SequentialOrder"></a> 順次処理
