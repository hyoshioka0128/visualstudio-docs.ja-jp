...
description: このクイックスタートでは、Visual Studio で Web パフォーマンスとロード テスト プロジェクトを作成し、実行する方法を学習します。
...
1. **[次へ]** を選択してウィザードを進め、**[テストをロード テスト シナリオに追加して、テスト ミックスを編集します]** ページまで移動します。 **[追加]** ボタンを選びます。
