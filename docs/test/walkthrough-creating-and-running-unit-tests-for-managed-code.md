...
description: マネージド コード用の Microsoft 単体テスト フレームワークと Visual Studio テスト エクスプローラーを使用して一連の単体テストを作成、実行、およびカスタマイズする方法について説明します。
...
3. .NET Core 用の C# **[コンソール アプリ]** プロジェクト テンプレートを検索して選択し、 **[次へ]** をクリックします。
...
2. 検索ボックスに「**単体テスト**」と入力し、言語として **C#** を選択してから、.Net Core テンプレートの C# **[単体テスト プロジェクト]** を選択し、 **[次へ]** をクリックします。
