...
description: ロード テスト エディター管理を使用して、コンピューターを選択し、各コンピューターから収集するカウンター セットを割り当てることによって、カウンター セットを管理する方法について説明します。
...
4. (省略可能) **[コンピューターの追加]** を選択して、監視する新しいコンピューターを追加します。 名前を入力するように求められます。 コンピューターの名前を入力すると、新しいエントリの下にノードが表示されます。 たとえば、**ASP.NET**、**IIS**、**SQL** などです。 選択するノードの横にあるチェック ボックスをオンにします。 新しいカウンターが **[選択のプレビュー]** ウィンドウに表示されます。
