---
title: ロード テスト結果の概要
description: ロード テストの概要を表示する方法について説明します。 ロード テストの概要には、主要な結果がわかりやすい形式で簡潔にまとめられています。
...
![[概要] ビュー](../test/media/ltest_summaryview.png)
...
## <a name="test-results"></a>Test results
