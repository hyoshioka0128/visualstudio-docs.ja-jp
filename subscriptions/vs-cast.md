...
- Visual Studio Enterprise サブスクライバーは、ユーザーによるアプリへのアクセスを最大 5 つまで許可する CAST Highlight の完全な機能のサブスクリプションを 3 か月間無料で使用することができます。
- Visual Studio Professional サブスクライバーは、1 つのアプリを 3 か月間評価できる同じようなサブスクリプションを使用できます。
...
0. また、ご自分の要求が受信されたことを確認する次の電子メールが CAST から届きます。  (この例では、Enterprise サブスクライバーが受信した電子メールを示しています。)
