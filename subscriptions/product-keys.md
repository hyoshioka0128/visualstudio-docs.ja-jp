...
> [!NOTE]
> サブスクリプションが職場または学校によって提供されている場合は、サブスクリプション管理者がソフトウェア ダウンロードにアクセスできるかどうかを制御します。  サブスクリプションのダウンロードへのアクセスが無効になっている場合は、プロダクト キーへのアクセスも無効になります。  ダウンロードやプロダクト キーが必要な場合は、[管理者にお問い合わせください](contact-my-admin.md)。
...
> ![ダウンロード ページからキーを入手する](_img/product-keys/download-get-key.png "[キーの取得] をクリックし、ダウンロードする製品のキーを要求します。")
...
> [!div class="mx-imgBorder"]
> ![[プロダクト キー] ページ](_img/product-keys/product-keys-page.png "[プロダクト キー] ページには、特定のサブスクリプションのプロダクト キー情報がすべて表示されます。")
