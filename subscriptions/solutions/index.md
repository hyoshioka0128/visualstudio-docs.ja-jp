---
title: サブスクリプション サポート ソリューション
description: Visual Studio サブスクリプション サポート ウィジェット コンテンツのインクルード ファイルの一覧
ms.topic: conceptual
...
## <a name="admin-solutions"></a>管理者ソリューション
...
## <a name="benefit-activations"></a>特典のアクティブ化
...
## <a name="download-activate-or-use-software"></a>ソフトウェアのダウンロード、アクティブ化、または使用

### <a name="downloads-and-activations"></a>ダウンロードとアクティブ化
...
### <a name="find-and-use-product-keys"></a>プロダクトキーの検索と使用
...
## <a name="other-solutions-or-no-solution"></a>その他のソリューション、またはソリューションなし

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>ポータルの問題
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>サブスクリプションの購入、更新、またはキャンセル

### <a name="help-with-purchases"></a>購入に関するヘルプ
...
### <a name="help-with-renewals"></a>更新に関するヘルプ
...
### <a name="help-with-canceling"></a>キャンセルに関するヘルプ
...
### <a name="order-or-purchase-status"></a>注文または購入の状態
...
## <a name="issues-with-signing-in"></a>サインインに関する問題 
