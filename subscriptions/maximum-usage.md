...
## <a name="maximum-usage-overview"></a>最大使用量の概要
...
2. サブスクライバー グリッドの左側の上から 3 番目のアイコンである **[最大使用量]** アイコンをクリックします。  

    > [!div class="mx-imgBorder"]
    > ![最大使用量のスライド アウト](_img/maximum-usage/maximum-usage-menu.png "[最大使用量] ボタンをクリックすると、割り当てたサブスクリプションの種類ごとに最大数が表示されます。")

3. [12-month maximum usage]\(12 か月の最大使用量\) が表示され、過去 1 年間に各レベルに割り当てたサブスクリプションの最大数とそのピークに達した月が表示されます。    

## <a name="view-your-assignment-history"></a>割り当て履歴を表示する
各サブスクリプション レベルのピークの割り当てを確認するだけでなく、 **[Export full report]\(完全なレポートのエクスポート\)** ボタンをクリックして、購入や割り当てを含む契約上のアクティビティの現在のアカウントを確認できます。  (そのボタンを表示するにはスクロール ダウンが必要な場合があります。)  

> [!div class="mx-imgBorder"]
> ![最大使用量の完全なレポート](_img/maximum-usage/maximum-usage-full-report.png "完全レポートには、サブスクリプション購入と割り当ての記録がすべて含まれます。")
