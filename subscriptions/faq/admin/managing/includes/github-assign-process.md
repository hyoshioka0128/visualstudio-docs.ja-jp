---
title: GitHub の設定プロセスとは
description: GitHub Enterprise サブスクリプションが Visual Studio サブスクライバーに割り当てられる方法について説明します。
ms.faqid: group1_4
ms.topic: include
...
ms.locfileid: "94626238"
---
## <a name="what-is-the-github-setup-process"></a>GitHub の設定プロセスとは
