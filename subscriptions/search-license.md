...
1. サブスクライバーの特定のグループを検索するには、 **[フィルター]** タブを選択します。
   ...
   > ![[フィルター] を選択してサブスクライバー一覧を検索する](_img/search-filter/filter-list.png)
...
2. 検索の基準として使用する条件を入力し、 **[フィルター]** をもう一度を選択します。
   ...
   **[フィルター]** アイコンが強調表示されるので、フィルターが適用されていることがわかります。  選択肢 **[フィルターのクリア]** も表示されます。 

3. フィルターをクリアし、フィルター処理されていない一覧を復元するには、右上にある **[フィルターのクリア]** タブをクリックします。 
   > [!div class="mx-imgBorder"]
   > ![サブスクライバー リストからフィルターをクリアする](_img/search-filter/clear-filter.png)
